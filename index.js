...
client.login('NTEyMjc2NzkxNjY3MTk1OTI1.XP2OxA.PK8kBuqlad5gmBtcsv2kybsKagA')



client.on('ready', function () {
    console.log('Bot connecté')
    client.user.setActivity('FAIRE DES DAB SUR COOKIE OOF', {type: "PLAYING"})
})
...
client.on('message', message =>{
    if(message.content === 'cookie oof'){
        message.reply('bah je tue des gens :heart: ');
        console.log('cookie oof command est actif');
    }

})

client.on('message', message =>{
    if(message.content === 'Spacior'){
        message.reply('DERRIER TOI MOUAAAAAA :heart: ');
        console.log('Spacior command est actif');
    }
...
client.on('guildMemberAdd', function (member) {
    ...
    member.guild.channels.get('581196466320572495').send(embed)
